...
(dolist (file '(utils defaults automode straight theme packages keybinds benchmark))
...
(when noninteractive
  (load (expand-file-name "lisp/trigger-compilation" user-emacs-directory) nil (not init-file-debug) nil 'must-suffix))
